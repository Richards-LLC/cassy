...
- Flag uncertain cases for manual review by writing a task note for the supervisor: `mcp__cs__task action=notes id=<task-id> note_type=question notes="<case and evidence>"` — don't merge if unsure
