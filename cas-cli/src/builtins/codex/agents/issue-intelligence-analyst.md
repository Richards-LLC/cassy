...
- **Task creation:** For each high-priority theme (confidence=high, count ≥ 5), offer to create a Cassy epic via `mcp__cs__task action=create task_type=epic title="Address <theme>" priority=1`. Do not create automatically — the caller decides.
