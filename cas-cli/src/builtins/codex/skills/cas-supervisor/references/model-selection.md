...
mcp__cs__factory action=spawn_workers count=1 isolate=true cli=claude model=opus effort=high
```
...
```
mcp__cs__factory action=spawn_workers count=1 isolate=true cli=opencode model=qwencloud/qwen3.8-max effort=medium worker_names="oc-ada"
```
