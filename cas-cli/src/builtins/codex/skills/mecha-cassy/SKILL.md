...
Set this machine up once with `cas integrate mecha-cassy` (see [references/registration.md](references/registration.md)), then dispatch from a Cassy-connected harness with `mcp__cs__mcp_execute`.
