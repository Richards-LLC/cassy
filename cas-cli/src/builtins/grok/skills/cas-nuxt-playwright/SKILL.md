...
description: Use only when the operator explicitly asks for Nuxt + Playwright E2E testing help; do not invoke for ordinary development, test edits, or routine verification.
managed_by: cas
user-invocable: true
---
