...
- **Never reply to the `From:` label:** use the reply command printed beside a verified Commander row (`cas__coordination action=message target=operator in_reply_to=N summary="..." message=…`).
