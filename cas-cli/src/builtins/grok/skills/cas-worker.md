...
- Do not use the built-in `SendMessage` tool — it's disabled in factory mode. This includes your first ready-ping at spawn: use `cas__coordination action=message` from the very first message.
