...
3. **Check overlap:** `mcp__cas__rule action=check_similar content="<rule content>"`. Look for near-duplicates and for contradictions with proven rules ("Always X" against "Never X").
4. **Decide and act:**
