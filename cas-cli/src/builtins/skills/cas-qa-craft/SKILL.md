...
3. Build the exploration matrix with [references/matrix-builder.md](references/matrix-builder.md):
   ...
   ([references/journeys.md](references/journeys.md)). Where `docs/qa/features/`
   exists, touched feature files feed the matrix, one entry point per row;
   "verified via another entry point" does not count. The kit is generated by
   [references/verify-harness.md](references/verify-harness.md), kept current by
   [references/maintain.md](references/maintain.md), and never a close prerequisite.
