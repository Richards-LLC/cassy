...
3. Resolve each hunk by preserving both intents where possible. If they are incompatible, choose the change matching the merge’s stated goal and record the trade-off with `mcp__cas__task action=notes note_type=decision`. Do not invent new behavior.
