...
```
mcp__cas__coordination action=server_start command="npm run dev" port=5173 task_id=<your task>
```
...
```
mcp__cas__coordination action=server_start command="npm run dev" cwd=apps/web port=5173 task_id=cas-1234
```
...
mcp__cas__coordination action=server_list task_id=cas-1234
```
...
```
mcp__cas__coordination action=server_stop id=dev-web
```
