...
Never reply to the `From:` label: use the exact `mcp__cas__coordination action=message target=operator in_reply_to=N message=…` command printed beside a verified Commander row.
