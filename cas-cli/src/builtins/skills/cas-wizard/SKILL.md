...
Run `bash -n` and static tracing only; do not run a wizard end-to-end because it opens browsers and blocks on human input. Keep task decisions and proof in `task`; this skill never creates a parallel tracker, setup system, or context file.
