...
| good | #2A7A54 | #5FC492 | status only |
| **warning** | #8C5F06 | #E2B14D | status only |
...
- Contrast: ink on bg 15.3:1 light, 14.8:1 dark; ink-muted on bg 5.8:1 light, 7.7:1 dark; verdict
  on bg 8.6:1 light, 9.3:1 dark; warning on bg 5.1:1 light; line-strong on bg 3.4:1 light, 3.9:1 dark. Every text role clears 4.5:1 and every mark role clears 3:1 on both backgrounds; `line` (1.35:1) is a hairline and never carries meaning.
...
Magnitude is a single-hue indigo ramp (five steps in the tokens). Polarity is danger → line →
