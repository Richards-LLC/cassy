...
File uploads are not proven by a shared envelope: treat every file receipt as untrusted until the downloaded bytes pass the source hash and decode checks below.
