...
impl CasService {
    ...
    pub async fn factory(
        ...
        let result = match action.as_str() {
            ...
            "recycle_worker" => self.factory_recycle_worker(req).await,
            ...
            "sweep_tasks" => self.factory_sweep_tasks(req).await,
