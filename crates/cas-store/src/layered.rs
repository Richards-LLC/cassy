...
use cas_types::{Entry, Rule, Scope, ScopeFilter, Skill, SkillStatus};

use crate::{Result, RuleStore, SkillStore, Store};
...
impl LayeredEntryStore {
    ...
    pub fn list_unreviewed_learnings(
        &self,
        limit: usize,
        filter: ScopeFilter,
    ) -> Result<Vec<Entry>> {
...
mod tests {
    use crate::layered::*;
    use crate::mock::{MockRuleStore, MockSkillStore, MockStore};
