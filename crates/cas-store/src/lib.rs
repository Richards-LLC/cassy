...
pub use knowledge_store::{
    ...
    KNOWLEDGE_PAGE_ATTRIBUTION_STATEMENTS, KNOWLEDGE_SCHEMA_STATEMENTS, KnowledgeHit,
    KnowledgePage, KnowledgePageOrigin, KnowledgeSource, KnowledgeStore, PageWrite, PendingSource,
    SourceClassification, SourceOutcome, SourceStatus, SqliteKnowledgeStore, blake3_hex,
    canonical_rel_path, classify_sources, hash_source_file, slugify,
};
