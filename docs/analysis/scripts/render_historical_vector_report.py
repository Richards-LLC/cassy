...
@media(prefers-color-scheme:dark){:root{--bg:#111827;--panel:#182235;--text:#f3f4f6;--muted:#c3cad5;--line:#8995a6;--accent:#83b4ff;--good:#71d99d;--warn:#ffc16b;--bad:#ff9696;--soft:#24334d}}
...
@media print{:root{--bg:#fff;--panel:#fff;--text:#000;--muted:#333;--line:#555;--accent:#174a8b;--soft:#eee}body{font-size:10.5pt}header,main,footer{max-width:none;padding:.4in}a[href^="http"]::after{content:" (" attr(href) ")";font-size:8pt}thead{display:table-header-group}tr,figure,.card,details{break-inside:avoid}details{display:block}details>*{display:block!important}.cards{grid-template-columns:repeat(4,1fr)}pre{background:#fff;color:#000;border:1px solid #555}}
</style>
"""
...
def main() -> None:
    ...
    rendered = subprocess.run(
        ["pandoc", "--from=gfm+raw_html", "--to=html5", "--standalone",
         "--metadata", "title=Historical CAS operational vector index — 2026-08-17",
