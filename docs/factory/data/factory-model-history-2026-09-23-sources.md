# Factory model history sources — 2026-09-23
...
- Transcript JSONL files scanned: 7193; factory transcript files parsed: 3029; joined to DB worker rows: 2580; transcript-only sessions: 449; transcript→DB miss rate: 14.82%.
- DB session rows without a transcript match: 8301 (76.74% of emitted rows).
- Prices JSON: `loaded`. Blank `cost_usd` means the model has no supplied price entry; no price was inferred.

### Transcript homes

- `/home/pippenz/.claude-alt/projects` (claude): 400 JSONL files, 151 factory files, 147 DB joins, 4 transcript-only; home miss rate 2.65% of factory files.
- `/home/pippenz/.claude-daniel@petrastella.io/projects` (claude): 1097 JSONL files, 197 factory files, 182 DB joins, 15 transcript-only; home miss rate 7.61% of factory files.
...
- `/home/pippenz/.claude-pippenz@gmail.com/projects` (claude): 1347 JSONL files, 78 factory files, 71 DB joins, 7 transcript-only; home miss rate 8.97% of factory files.
- `/home/pippenz/.claude-support@gabber.studio/projects` (claude): 997 JSONL files, 371 factory files, 369 DB joins, 2 transcript-only; home miss rate 0.54% of factory files.
...
- `/home/pippenz/.claude-support@petrastella.io/projects` (claude): 6 JSONL files, 0 factory files, 0 DB joins, 0 transcript-only; home miss rate 0.00% of factory files.
- `/home/pippenz/.claude/projects` (claude): 155 JSONL files, 84 factory files, 83 DB joins, 1 transcript-only; home miss rate 1.19% of factory files.
- `/home/pippenz/.codex-pippenz@gmail.com/sessions` (codex): 137 JSONL files, 115 factory files, 111 DB joins, 4 transcript-only; home miss rate 3.48% of factory files.
- `/home/pippenz/.codex-support@gabber.studio/sessions` (codex): 121 JSONL files, 110 factory files, 110 DB joins, 0 transcript-only; home miss rate 0.00% of factory files.
- `/home/pippenz/.codex/sessions` (codex): 2930 JSONL files, 1923 factory files, 1507 DB joins, 416 transcript-only; home miss rate 21.63% of factory files.

- `pippenz` DB `/home/pippenz/.cas/cas.db`: 0 spawn rows (0 without a resolvable worker name skipped), 0 lease events, 0 tasks; task notes source `tasks.notes`; factory logs `8` files/0 JSON lines.
...
- `Accounting` DB `/home/pippenz/Documents/Accounting/.cas/cas.db`: 49 spawn rows (0 without a resolvable worker name skipped), 240 lease events, 85 tasks; task notes source `tasks.notes`; factory logs `7` files/1239 JSON lines.
- `2022` DB `/home/pippenz/Documents/Petra Stella/Accounting/Roark Realty/2022/.cas/cas.db`: 0 spawn rows (0 without a resolvable worker name skipped), 0 lease events, 0 tasks; task notes source `tasks.notes`; factory logs `3` files/0 JSON lines.
- `Penguinz` DB `/home/pippenz/Penguinz/.cas/cas.db`: 167 spawn rows (47 without a resolvable worker name skipped), 547 lease events, 1147 tasks; task notes source `tasks.notes`; factory logs `44` files/3449 JSON lines.
...
- `Petrastella` DB `/home/pippenz/Petrastella/.cas/cas.db`: 0 spawn rows (0 without a resolvable worker name skipped), 0 lease events, 693 tasks; task notes source `tasks.notes`; factory logs `1` files/0 JSON lines.
- `Rapidworth` DB `/home/pippenz/Petrastella/Rapidworth/.cas/cas.db`: 0 spawn rows (0 without a resolvable worker name skipped), 0 lease events, 0 tasks; task notes source `tasks.notes`; factory logs `3` files/0 JSON lines.
- `abundant-mines` DB `/home/pippenz/Petrastella/abundant-mines/.cas/cas.db`: 268 spawn rows (58 without a resolvable worker name skipped), 867 lease events, 1385 tasks; task notes source `tasks.notes`; factory logs `19` files/5120 JSON lines.
- `cas-src` DB `/home/pippenz/Petrastella/cas-src/.cas/cas.db`: 1195 spawn rows (186 without a resolvable worker name skipped), 5286 lease events, 3058 tasks; task notes source `tasks.notes`; factory logs `74` files/28892 JSON lines.
...
- `gabber-studio` DB `/home/pippenz/Petrastella/gabber-studio/.cas/cas.db`: 807 spawn rows (126 without a resolvable worker name skipped), 4100 lease events, 3321 tasks; task notes source `tasks.notes`; factory logs `62` files/20939 JSON lines.
...
- `ozer` DB `/home/pippenz/Petrastella/ozer/.cas/cas.db`: 358 spawn rows (149 without a resolvable worker name skipped), 1882 lease events, 2842 tasks; task notes source `tasks.notes`; factory logs `47` files/3908 JSON lines.
...
- `mecha_cassy` DB `/home/pippenz/Petrastella/petra_stella_tools/mecha_cassy/.cas/cas.db`: 21 spawn rows (1 without a resolvable worker name skipped), 96 lease events, 825 tasks; task notes source `tasks.notes`; factory logs `5` files/789 JSON lines.
- `petra-stella-cloud` DB `/home/pippenz/Petrastella/petra_stella_tools/petra-stella-cloud/.cas/cas.db`: 134 spawn rows (19 without a resolvable worker name skipped), 498 lease events, 330 tasks; task notes source `tasks.notes`; factory logs `23` files/2662 JSON lines.
- `project-management` DB `/home/pippenz/Petrastella/petra_stella_tools/project-management/.cas/cas.db`: 23 spawn rows (13 without a resolvable worker name skipped), 214 lease events, 93 tasks; task notes source `tasks.notes`; factory logs `7` files/1042 JSON lines.
- `docs` DB `/home/pippenz/Petrastella/petra_stella_tools/project-management/docs/.cas/cas.db`: 0 spawn rows (0 without a resolvable worker name skipped), 0 lease events, 0 tasks; task notes source `unavailable`; factory logs `1` files/0 JSON lines.
  Unavailable: full task notes (tasks.notes column absent).
...
- `pixel-hive` DB `/home/pippenz/Petrastella/pixel-hive/.cas/cas.db`: 13 spawn rows (0 without a resolvable worker name skipped), 55 lease events, 208 tasks; task notes source `tasks.notes`; factory logs `3` files/208 JSON lines.
...
- `pulse-card` DB `/home/pippenz/Petrastella/pulse-card/.cas/cas.db`: 50 spawn rows (0 without a resolvable worker name skipped), 228 lease events, 952 tasks; task notes source `tasks.notes`; factory logs `11` files/1227 JSON lines.
- `rocketship-template` DB `/home/pippenz/Petrastella/rocketship-template/.cas/cas.db`: 155 spawn rows (20 without a resolvable worker name skipped), 1064 lease events, 4614 tasks; task notes source `tasks.notes`; factory logs `10` files/5192 JSON lines.
...
- `Ops` DB `/home/pippenz/Richards LLC/Ops/.cas/cas.db`: 0 spawn rows (0 without a resolvable worker name skipped), 0 lease events, 0 tasks; task notes source `tasks.notes`; factory logs `1` files/0 JSON lines.
