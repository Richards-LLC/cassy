...
- **Latest release-note evidence:** the local `~/.grok/CHANGELOG.md` snapshot
  ...
  The official [Grok Build changelog](https://x.ai/build/changelog), fetched
  2026-09-23, still advertises **0.2.117** as its latest release and supplies
  no attributable 1.0.6–1.0.40 entries.
- **Gap:** the validated pin remains **1.0.5** because the complete live
  `PtyConfig::grok` matrix has not been rerun against 1.0.40. Releases 1.0.6–1.0.13
  have local release notes but no newer validation receipt; 1.0.14–1.0.40 have
  no attributable release-note source in either changelog surface. The required
  validation is tracked separately in **cas-ef93** and
  must not be inferred from this diary update. The earlier 0.2.102–0.2.103 and
  0.2.107–0.2.111 gaps remain documented below.
...
|--------------|----------|-------------|---------|
| 1.0.40 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.39 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.38 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.37 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.36 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.35 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.34 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.33 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.32 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.31 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.30 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.29 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.28 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.27 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.26 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.25 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.24 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.23 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.22 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.21 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.20 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.19 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.18 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.17 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.16 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.15 | No attributable release notes in retained sources | — (source gap) | this doc |
| 1.0.14 | No attributable release notes in retained sources | — (source gap) | this doc |
...
### 1.0.40 — official/local changelog source gap

Reviewed 2026-09-23. The installed binary reports **1.0.40** (`eb1a2256660d`),
but neither the versioned `~/.grok/CHANGELOG.md` snapshot nor its flat
`~/.grok/CHANGELOG.json` attributes release notes to 1.0.40. The official
[Grok Build changelog](https://x.ai/build/changelog) currently advertises
0.2.117 and has no attributable 1.0.40 section. → — **no attributable
evidence; no Cassy verdict is inferred.** Required live validation is tracked
in **cas-ef93**.

### 1.0.39 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.39; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.39
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.38 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.38; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.38
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.37 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.37; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.37
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.36 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.36; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.36
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.35 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.35; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.35
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.34 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.34; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.34
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.33 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.33; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.33
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.32 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.32; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.32
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.31 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.31; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.31
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.30 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.30; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.30
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.29 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.29; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.29
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.28 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.28; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.28
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.27 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.27; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.27
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.26 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.26; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.26
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.25 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.25; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.25
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.24 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.24; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.24
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.23 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.23; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.23
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.22 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.22; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.22
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.21 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.21; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.21
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.20 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.20; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.20
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.19 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.19; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.19
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.18 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.18; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.18
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.17 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.17; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.17
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.16 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.16; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.16
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.15 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.15; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.15
section. → — **no attributable evidence; no Cassy verdict is inferred.**

### 1.0.14 — official/local changelog source gap

Reviewed 2026-09-23. Neither the versioned `~/.grok/CHANGELOG.md` snapshot nor
its flat `~/.grok/CHANGELOG.json` attributes release notes to 1.0.14; the
[official changelog](https://x.ai/build/changelog) has no attributable 1.0.14
section. → — **no attributable evidence; no Cassy verdict is inferred.**
...
- **`grok clone` reuses matching local checkouts as linked worktrees.** → 👀
  **watch — worktree containment.** This is a Grok-owned optimization and does
  ...
  leases; validate path and branch isolation in the separate **cas-ef93**
  matrix.
...
- **1.0.40 validation:** ⏳ separate Cassy task **cas-ef93** owns the complete
  live `PtyConfig::grok` matrix; do not advance the validated pin from 1.0.5
  until its typed receipt passes.
