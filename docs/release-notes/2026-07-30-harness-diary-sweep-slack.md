...
Claude brings mostly host-side reliability wins; Codex refreshes several live integration paths; and Grok's newest attributable notes expose useful changes alongside substantial upstream history gaps. This is a harness compatibility and watch-ledger update—not a CAS runtime release.
