# Slack draft — Cassy v2.70.0 runtime release
...
**Top-level:**
Live on production — **User** — Cassy v2.70.0 makes Commander usable on a phone: a session that used to take about 44.7 MB to open now opens in roughly 17 KB.
