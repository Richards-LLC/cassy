...
describe("binding Commander browser invariants", () => {
  ...
  it("explains why legacy Pair is disabled without an invitation while keeping invitation pairing enabled", async () => {
    ...
    expect(source).toContain('<button type="submit" class="primary" ${pendingPairing ? "" : "disabled"}>Pair</button>');
  });
